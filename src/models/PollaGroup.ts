...
const PollaGroupSchema = new Schema<PollaGroupDocument>(
  {
    ...
    tournamentName: {
      ...
      trim: true,
      maxlength: [80, "El nombre del torneo no puede exceder 80 caracteres"],
    },
...
const PollaGroup: Model<PollaGroupDocument> =
  mongoose.models.PollaGroup ||
  mongoose.model<PollaGroupDocument>("PollaGroup", PollaGroupSchema);
